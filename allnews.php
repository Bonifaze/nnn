...
<body class="not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-1186 node-type-oxweb-news-index domain-oxweb vid-9382657 page-news-and-events" >
            <div id="skip-link">
              ...
              <div class="wrapper">
                <div class="row">
                  <div class="breadcrumb">
                    <span class='breadcrumb-link breadcrumb-depth-0 breadcrumb-even breadcrumb-first'><a href="index.php">Home</a></span>
                    <span class='breadcrumb-link breadcrumb-depth-1 breadcrumb-odd breadcrumb-last'>News </span></div>
                </div>
              </div>
            </section>
              ...
              <h1>News</h1>
                               ...
                               <div class="card-container">
                                ...
                                <a href="./singlenews.php">
                                    <div class="card">
                                      <img src="public/image/3.JPG" alt="Card Image">
                                      <div class="card-content">
                                        <h2>Card Title 1</h2>
                                        <p>This is a brief description of the card. If the description is too long, it should be truncated with ellipsis.</p>
                                      </div>
                                    </div>
                                  </a> 
