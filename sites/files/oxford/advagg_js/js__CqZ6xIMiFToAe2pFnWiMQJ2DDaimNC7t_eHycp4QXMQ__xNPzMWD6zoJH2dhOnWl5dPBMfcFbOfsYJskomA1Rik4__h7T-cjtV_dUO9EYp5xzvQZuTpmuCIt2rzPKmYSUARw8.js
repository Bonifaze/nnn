...
(function($, Drupal){
  ...
  // Gardengnome player behavior.
  Drupal.behaviors.gardengnome_player = {
    attach: function(context, settings) {
      // Trigger Popups
      $('.gardengnome-player', context).once(function(){
        var $el = $(this);
        if ($el.data('display') === 'popup') {
          ...
          $el.click(function(event){
            ...
            var popup = window.open(Drupal.settings.basePath + 'gardengnome-player-popup?package=' + file, 'Gardengnome Player', params);
